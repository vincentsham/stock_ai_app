...
def initialize_analyst_grade_mapping_table():
    ...
    for grade_original, grade_normalized, grade_value in init_grade_mapping:
        ...
        total_records_inserted += insert_record(conn, grade_original, grade_normalized, grade_value, embedding, embedding_model_used)
    conn.commit()
    conn.close()
...
if __name__ == "__main__":
    ...
    total_inserted = initialize_analyst_grade_mapping_table()
    print(f"Total records inserted into analyst_grade_mapping: {total_inserted}")
