...
def main(tic=None, type: Literal["news", "earnings_transcript"] = "news",
    ...
    if conn:
        if tic:
            query = QUERY_with_tic[type][frequency].format(tic=tic)
        else:
...
if __name__ == "__main__":
    # main(type="earnings_transcript", frequency="quarterly", top_k=1, year=2025, quarter=1, batch_size=5, sleep_time=185, idx=0)
    # main(type="earnings_transcript", frequency="quarterly", top_k=1, year=2025, quarter=2, batch_size=5, sleep_time=185, idx=0)
    # main(type="earnings_transcript", frequency="quarterly", top_k=1, year=2025, quarter=3, batch_size=5, sleep_time=185, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=6, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=7, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=8, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=9, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=10, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=11, batch_size=5, sleep_time=125, idx=0)
    main(type="news", frequency="monthly", top_k=1, year=2025, month=12, batch_size=5, sleep_time=125, idx=0)
    ...
    #         tic = record[0]
    #         main(tic=tic, type="earnings_transcript", frequency="quarterly", top_k=1, year=2025, quarter=1)
