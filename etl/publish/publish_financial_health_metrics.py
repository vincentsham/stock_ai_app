...
def main():
    ...
    if conn:
        ...
        try:
            total_deleted = delete_published_records(conn, "mart.financial_health_metrics", today, commit=False)
            ...
            for record in records:
                ...
                df = df[cols]
                total_inserted = insert_records(conn, df, "mart.financial_health_metrics", 
                                            ["tic", "date", "as_of_date"], 
